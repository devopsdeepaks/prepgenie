...
export function AddContainer() {
    ...
    return (
        (<div className="flex flex-row">
            <div
                className="relative m-4 w-1/3 rounded-3xl overflow-hidden   shadow-2xl shadow-zinc-900 bg-gradient-to-br from-[#0C0C0D] to-black p-8 my-10">
                <Rays />
                {/* <Beams /> */}
            ...
            <div
                className="rounded-3xl w-1/3 m-4 overflow-hidden   shadow-2xl shadow-zinc-900 bg-gradient-to-br from-[#0C0C0D] to-black p-8 my-10">
                <Rays />
                {/* <Beams /> */}
                <div className="relative z-10">
                    <Lens hovering={hovering} setHovering={setHovering}>
            ...
            <div
                className="flex w-1/3 m-4 relative rounded-3xl overflow-hidden   shadow-2xl shadow-zinc-900 bg-gradient-to-br from-[#0C0C0D] to-black p-8 my-10">
                <Rays />
                {/* <Beams /> */}
                <div className="relative z-10">
                    <Lens hovering={hovering} setHovering={setHovering}>
