                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            ...
                            <motion.button
                                className="bg-white text-black no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-lg px-8 py-4 text-lg font-semibold leading-6 inline-block mt-5 mb-2"
                                initial={{ scale: 1 }}
